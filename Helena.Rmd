...
So for "high" group (i.e: eqpdays more than 700), we can offer a discount of 5% via 36 monthly payments including a new phone and the plan based on what the customer's choice.
We assume that for each person, the incentive decrese the churning probability by 0.2 percent
...
```{r}
eqpdays_clv <- cal_clv(pred_logit, 0.40)
```
