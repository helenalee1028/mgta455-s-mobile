...
eqpdays - statistically speaking, 2 standard deviations increase in overage, equivalent to 
`r round(2 * sd(train_val$eqpdays), 2)` minutes, would increase the odds of churning by 80。6%, keeping everything else constant.
